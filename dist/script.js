...
const calc = (size, material, options, promocode, result) => {
  ...
  const calcFunc = () => {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = "Виберіть розмір та матеріал картини";
...
const modals = state => {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', () => {
      if (!btnPressed && window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight - 50) {
...
/***/ "./src/js/modules/scrollingRAF.js":
/*!****************************************!*\
  !*** ./src/js/modules/scrollingRAF.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (scrollingRAF);
...
/* harmony import */ var _modules_scrollingRAF__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/scrollingRAF */ "./src/js/modules/scrollingRAF.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // scrolling('.pageup');
  (0,_modules_scrollingRAF__WEBPACK_IMPORTED_MODULE_11__["default"])('.pageup');
});
})();
